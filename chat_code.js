...
//         bu = "";
        ...
        document.getElementById("output").innerHTML += "<h4> " + name + "<img class='user_tick' src='tick.png'></h4>"+'<img src='+message_data['dataUriOfImage']+' class="img-responsive" height="200px" width="200px"><hr><br><br>';
        console.log('Img')
        } else if(message_data['type'] == 'Vid'){
          document.getElementById("output").innerHTML += "<h4> " + name + "<img class='user_tick' src='tick.png'></h4>"+'<video src='+message_data['dataUriOfVideo']+' class="img-responsive" height="400px" width="500px" controls><hr><br><br>';
